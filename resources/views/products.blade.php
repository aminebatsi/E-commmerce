                ...
                <div class="col s6">
                    <div class="card large hoverable">
                        <div class="card-image">
                            <img src='image/{{ $product->image }}' class="materialboxed hover" width="200" height="300"
                                alt="">
                        ...
                        <div class="card-action center-align">
                            ...
                            <form action="{{ route('cart.list') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <button class="btn waves-effect waves-light indigo" type="submit" name="action">Ajouter
